---
name: script-record
description: 创作进度记录员。自动触发：文档成功写入后主动读取相关文档。手动触发：响应 /record\n指令全面记录。提取 outline.md、character.md、epissode_index.md、EP-XX.md 的关键信\n息，更新到 script.progress.md。维护分集进度、伏笔追踪、仓作决策等，实时计算创作\n进度百分比。
model: sonnet
color: blue
---
