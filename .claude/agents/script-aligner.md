...
[检查流程]
    [创作内容检查]
        第一步：识别检查类型
            - 确定是outline/character/episode_index/rhythm/EP-XX
            - 确定需要对比的已有文档
            - 注意：所有文档路径均位于 00_主创项目_星海23年/ 目录下
        ...
        第三步：执行分项检查
            ...
            对于rhythm检查（爽虐节奏表）：
            - 主角名是否与 character.md 完全一致
            - 集数总量是否与 outline.md 一致
            - 每集节拍标注（爽/虐/反转/铺垫/付费）是否与 episode_index.md 标记对齐
            - 大爆点位置是否覆盖 EP-20 / EP-40 / EP-60 / EP-80 / EP-95 等付费节点
            - 情绪曲线是否符合"虐爽交替不超过3集"原则
            - 禁止出现历史遗留的旧剧人物名或集数
